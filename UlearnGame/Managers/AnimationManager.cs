...
{
    public class AnimationManager : ICloneable //логика анимации в игре
    {
        ...
        public float Layer { get; set; } //Слой

        public Vector2 Origin { get; set; } //начальное движение

        public Vector2 Position { get; set; } // позиция

        public float Rotation { get; set; } //Вращение
